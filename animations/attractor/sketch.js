...
function setup() {
  ...
  let col = color(randColour(0, 200));
  let start_text =
    "click on the eye of the attractor (black dot) to focus on an attractor . Then click in direction of where u want it to go (it moves slow) . double click to stop";
  createText(start_text, col, 10);
}
...
// Stops the motion of attractor
function doubleClicked() {
  attractor_cursor.vel.set(0, 0);
}
